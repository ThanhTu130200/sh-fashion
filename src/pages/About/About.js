				...
				<Row xs={1} md={2}>
					...
					<Col>
						...
						<p className="text-muted fs_10">
							...
							a, gravida vitae, dapibus risus ante sodales lectus blandit eu, tempor
							...
							Nullam viverra consectetuer. Quisque cursus et, porttitor risus. Aliquam
							sem. In hendrerit nulla quam nunc, accumsan congue. Lorem ipsum primis
							in nibh vel risus. Sed vel lectus. Ut sagittis, ipsum dolor quam.
						</p>
					</Col>
				</Row>
			</Container>
